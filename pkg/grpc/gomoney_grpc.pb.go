...
type TransactionServiceClient interface {
	...
	GetTransactionSummary(ctx context.Context, in *StringID, opts ...grpc.CallOption) (*ManyTransactions, error)
	// this returns all transactions for a particular account owned by user id
	GetTransactions(ctx context.Context, in *UserWithAccount, opts ...grpc.CallOption) (*ManyTransactions, error)
}
...
func (c *transactionServiceClient) GetTransactionSummary(ctx context.Context, in *StringID, opts ...grpc.CallOption) (*ManyTransactions, error) {
	out := new(ManyTransactions)
...
func (c *transactionServiceClient) GetTransactions(ctx context.Context, in *UserWithAccount, opts ...grpc.CallOption) (*ManyTransactions, error) {
	out := new(ManyTransactions)
...
type TransactionServiceServer interface {
	...
	// this returns the last 10 transactions for every account owned by user id
	GetTransactionSummary(context.Context, *StringID) (*ManyTransactions, error)
	// this returns all transactions for a particular account owned by user id
	GetTransactions(context.Context, *UserWithAccount) (*ManyTransactions, error)
...
func (UnimplementedTransactionServiceServer) GetTransactionSummary(context.Context, *StringID) (*ManyTransactions, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTransactionSummary not implemented")
}
func (UnimplementedTransactionServiceServer) GetTransactions(context.Context, *UserWithAccount) (*ManyTransactions, error) {
